...
const Navbar = () => {
	...
	return (
		<nav
			className={`${navbarStyles.nav.base} ${isScrolled ? navbarStyles.nav.scrolled : navbarStyles.nav.notScrolled
				}`}
		>
							...
							return (
								<div key={item.id} className={navbarStyles.desktopNavItem}>
									<NavLink
										...
										className={({ isActive }) =>
											`${navbarStyles.desktopNavLink.base} ${isActive
						...
						{navItems.map((item) => {
							...
							return (
								<NavLink
									...
									className={({ isActive }) =>
										`${navbarStyles.tabletNavLink.base} ${isActive
								...
								>
									...
									<span className={navbarStyles.tabletNavLabel}>
										{item.label}
									</span>
								</NavLink>
							);
						...
						<div className={navbarStyles.desktopAuth}>
							{isLoggedIn ? (
								<button
									...
									className={navbarStyles.authButton}
							...
							{navItems.map((item) => {
								...
								return (
									<NavLink
										...
										className={({ isActive }) =>
											`${navbarStyles.mobileNavLink.base} ${isActive
